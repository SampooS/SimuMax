...
public interface IVisualisointi {
	...
	Label aktiiviaika,Label palvellutAsiakkaat,Label kayttoaste, 
	Label suoritusteho,Label keskiKayttoaste,ImageView kaasaktiivi,
	ImageView kassakaytto,ImageView kassakeskikaytto, ImageView kassasuoritusteho);
	
	public void setLoadPane(
	ListView<String> loadlist,Pane esitiedotpane,Label esiasiakas,
	Label esiruokalinja,Label esikassa,Label esiryhmia,Label esiporrastusaika);
